...
describe("useFacilitator", () => {
  ...
  describe("verify", () => {
    it("should call fetch with the correct data and default URL", async () => {
      ...
      expect(fetch).toHaveBeenCalledWith("https://x402.0xgasless.com/verify", {
        method: "POST",
  ...
  describe("settle", () => {
    it("should call fetch with the correct data and default URL", async () => {
      ...
      expect(fetch).toHaveBeenCalledWith("https://x402.0xgasless.com/settle", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          x402Version: mockPaymentPayload.x402Version,
  ...
  describe("supported", () => {
    it("should call fetch with the correct default URL", async () => {
      ...
      expect(fetch).toHaveBeenCalledWith("https://x402.0xgasless.com/supported", {
        headers: { "Content-Type": "application/json" },
        method: "GET",
      });
    });
  ...
  describe("list", () => {
    it("should call fetch with the correct URL and method", async () => {
      ...
      expect(fetch).toHaveBeenCalledWith("https://x402.0xgasless.com/discovery/resources?", {
        method: "GET",
        headers: { "Content-Type": "application/json" },
      });
    });
    ...
    it("should properly encode query parameters", async () => {
      ...
      const expectedUrl =
        "https://x402.0xgasless.com/discovery/resources?type=test-type&limit=10&offset=20";
    ...
    it("should filter out undefined query parameters", async () => {
      ...
      const expectedUrl =
        "https://x402.0xgasless.com/discovery/resources?type=test-type&limit=10";
      expect(fetch).toHaveBeenCalledWith(expectedUrl, {
        method: "GET",
        headers: { "Content-Type": "application/json" },
      });
